// One entry per livestreamed room. `slug` is our /watch/ URL, `ccc` the room slug on streaming.media.ccc.de.
...
export const streams = [
    ...
    },
    {
        ...
        name: "Katherine",
        pretalxRoom: 6345,
        chat: "#katherine-mc26:matrix.org",
    },
    {
        slug: "peter",
        ccc: "peter",
...
export const cccEmbed = (slug: string) =>
    `https://streaming.media.ccc.de/${CCC_CONFERENCE}/embed/${slug}`;
